  ...
  return (
    <Box>
      ...
      <Box p={10} bg="gray.100">
        ...
        <Stack spacing={4}>
          <Flex justify="space-between">
            <Text fontSize="xl">July 15 - New York, NY</Text>
            <Button colorScheme="blue" size="sm">
              Tickets
            </Button>
          </Flex>
          <Flex justify="space-between">
            <Text fontSize="xl">July 20 - Los Angeles, CA</Text>
            <Button colorScheme="blue" size="sm">
              Tickets
            </Button>
          </Flex>
          <Flex justify="space-between">
            <Text fontSize="xl">July 25 - Chicago, IL</Text>
            <Button colorScheme="blue" size="sm">
              Tickets
            </Button>
          </Flex>
      ...
      <Box p={10}>
        ...
        <Flex>
          <Image src="https://images.unsplash.com/photo-1470790376778-a9fbc86d70e2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w1MDcxMzJ8MHwxfHNlYXJjaHwxfHxyb2NrJTIwYWxidW0lMjBjb3ZlcnxlbnwwfHx8fDE3MTAzMzI0MzV8MA&ixlib=rb-4.0.3&q=80&w=1080" alt="Album Cover" boxSize="300px" objectFit="cover" mr={8} />
          <Box>
            <Heading as="h3" size="xl" mb={4}>
              Rockstar Anthems
            </Heading>
            <Text fontSize="xl" mb={4}>
              Check out our latest album featuring hit singles like "Rock On" and "Midnight Jam".
            </Text>
